...
* Div – container for grouping UI elements, supports nested Divs
* Text – display static or dynamic text
* Button – supports hover color, click events, dynamic updates
* Input – single-line and multi-line input, dynamic text updates
...
This is beginner-friendly, simple, and ready to track before your first alpha release.
